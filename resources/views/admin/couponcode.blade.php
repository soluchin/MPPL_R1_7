                                    ...
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                ...
                                                <a href="#" class="ver_container"><img src="{{asset('images/ex/04-01.jpg')}}" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="coupons-code-item flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="{{asset('images/ex/04-04.jpg')}}" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="coupons-code-item flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="{{asset('images/ex/04-05.jpg')}}" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
