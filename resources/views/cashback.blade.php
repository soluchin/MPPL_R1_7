                    ...
                    <div class="block-content list-coupon clearfix">
                        <div class="tab-content">
                            <div class="tab-content-item active">
                                @foreach ($cashback as $cb)
                                <div class="coupon-item grid_3">
                                    <div class="coupon-content">
                                        <div class="img-thumb-center">
                                            <div class="wrap-img-thumb">
                                                <span class="ver_hold"></span>
                                                <a href="coupon-detail.html" class="ver_container"><img src="{{$cb->image}}" alt="$COUPON_TITLE"></a>
                                            </div>
                                        </div>
                                        <div class="coupon-price">Cashback Rp{{$cb->nominal}}</div>
                                        <div class="coupon-brand">{{$cb->brands}}</div>
                                        <div class="coupon-desc">{{$cb->description}}</div>
                                        <div class="time-left">{{$cb->time}} days left</div>
